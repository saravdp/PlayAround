...
function fillTable() {
    let container = document.getElementById("receivedTable")
    let pedidos = getRequestsOfUserEvents(userInfo._id)
...
<td onclick="respondRequest(${ped.id}, 'true')"><i class="fa fa-check-square column is-centered" aria-hidden="true"></i></td>

<td onclick="respondRequest(${ped.id}, 'false')"><i class="fa fa-minus-circle column is-centered" aria-hidden="true"></i></td>
</tr>
`}
    }
